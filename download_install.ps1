...
Start-Process -FilePath "SteamSetup.exe" -WorkingDirectory "C:\Users\Public\Public Downloads" -Wait
...
Start-Process -FilePath "EAappInstaller.exe" -WorkingDirectory "C:\Users\Public\Public Downloads" -Wait
...
Expand-Archive -Path "C:/Users/Public/Public Downloads/GenPatcher.zip" -DestinationPath "C:\Users\Public\Public Downloads"
