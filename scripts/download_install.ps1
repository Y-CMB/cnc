...
# genpatcher
Invoke-WebRequest -Uri "https://legi.cc/downloads/genpatcher/GenPatcher%202.07f.zip" -OutFile "C:/Users/vagrant/Downloads/GenPatcher.zip"
Expand-Archive -Path "C:/Users/vagrant/Downloads/GenPatcher.zip" -DestinationPath "C:\Users\Public\Downloads"
